        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="relative rounded-3xl overflow-hidden shadow-2xl shadow-primary/15"
            >
              <img
                src={crHeroImage}
            ...
            <motion.div
              ...
              className="absolute -right-4 top-8 lg:top-12 bg-white backdrop-blur-md rounded-2xl p-5 shadow-2xl border-2 border-border hover:border-accent transition-colors"
            >
            ...
            <motion.div
              variants={floatingBadge}
              className="absolute -left-4 bottom-8 lg:bottom-12 bg-white backdrop-blur-md rounded-2xl p-5 shadow-2xl border-2 border-border hover:border-accent transition-colors"
            >
              <div className="flex items-center gap-4">
