...
const StepCard = ({ icon: Icon, title, description }: StepCardProps) => (
  <div className="group flex items-start gap-4 p-4 rounded-xl bg-white border border-border/50 hover:border-accent/30 hover:shadow-md transition-all duration-300">
