              ...
              <div className="lg:col-span-7">
                ...
                <div className="mt-6 glass-card-light p-6 md:p-7">
                  <div className="flex flex-col md:flex-row gap-4 md:items-center md:justify-between">
                    ...
                    <Button onClick={() => scrollToId("book")}>
                      Book now
                    </Button>
                  </div>
                </div>
              ...
              <div className="card-elevated p-2 md:p-3">
                <Accordion type="single" collapsible>
                  <AccordionItem value="a">
                    ...
                    <AccordionContent>
                      Many setups can be completed in roughly 3–7 business days, depending on activities, approvals, and
                      documents.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="b">
                    ...
                    <AccordionContent>
                      Yes—many activities allow 100% foreign ownership. We’ll confirm eligibility based on your activity
                      and structure.
                    </AccordionContent>
                  </AccordionItem>
