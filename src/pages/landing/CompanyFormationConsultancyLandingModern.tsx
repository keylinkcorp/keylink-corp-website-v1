...
// IMPORTANT: Keep content identical to V2; only meta identifiers differ.
const FAQS: FaqItem[] = [
  {
  ...
  },
  {
    ...
    answer: "No. We are an independent business consultancy. CR is issued only by Bahrain government authorities.",
  },
];
...
export default function CompanyFormationConsultancyLandingModern() {
  ...
  useEffect(() => {
    ...
    // NOTE: Unique identifiers so we don't collide with V2.
    ...
    // Route sanity check (non-visual)
    if (typeof window !== "undefined" && window.location.pathname !== "/lp/company-formation-consultancy-modern") {
      // eslint-disable-next-line no-console
      console.warn(
        `[CFC Modern] Expected /lp/company-formation-consultancy-modern but got ${window.location.pathname}`
      );
    }
              ...
              <div className="grid gap-8 lg:grid-cols-12 lg:items-start">
                <div className="lg:col-span-5">
                  <div className="lp-card p-6">
                    ...
                    <div className="mt-6">
                      <Button className="w-full" onClick={() => scrollToId("calculator-form")}>
                        Start
                      </Button>
                    </div>
                ...
                <div className="lg:col-span-7">
                  ...
                  <h3 className="lp-h2" id="calculator-form">
                  ...
                  <div className="lp-card p-6">
                    ...
                    <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
                      <li className="flex items-start gap-2">
                        <span className="mt-1 h-1.5 w-1.5 rounded-full bg-muted-foreground/60" />Research approvals across
                        sources
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 h-1.5 w-1.5 rounded-full bg-muted-foreground/60" />Trial-and-error on
                        sequencing
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 h-1.5 w-1.5 rounded-full bg-muted-foreground/60" />Unclear document readiness
                      </li>
                    </ul>
                  </div>
                  <div className="lp-card p-6">
                    ...
                    <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
                      <li className="flex items-start gap-2">
                        <span className="mt-1 h-1.5 w-1.5 rounded-full bg-muted-foreground/60" />Tailored checklist +
                        sequencing
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 h-1.5 w-1.5 rounded-full bg-muted-foreground/60" />Clear cost drivers & trade-offs
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 h-1.5 w-1.5 rounded-full bg-muted-foreground/60" />Realistic timeline expectations
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <section aria-label="Process timeline" className="section-spacing-sm relative overflow-hidden bg-muted/10">
            <div className="container mx-auto px-4 md:px-6 relative">
              <div className="max-w-3xl">
                ...
                <p className="lp-section-subtitle">A simple, structured flow—so you know what to expect.</p>
              </div>
              ...
              <div className="mt-8 grid gap-4">
                {[
                  ...
                  {
                    title: "2) We confirm your inputs",
                    desc: "We validate the cost drivers and clarify what approvals typically apply.",
                  },
                  {
                    title: "3) You receive a checklist",
                    desc: "Tailored documents list + sequence based on shareholders/activity.",
                  },
                  {
                    title: "4) You proceed with clarity",
                    desc: "If you want ongoing guidance, we align on next steps and coordination.",
                  },
                ].map((s, idx) => (
                ...
                <div className="lg:col-span-5">
                  ...
                  <div className="mt-5 lp-card-flat bg-muted/20 p-6">
                    ...
                    <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                      <li className="flex items-start gap-2">
                        <Check className="mt-0.5 h-4 w-4 text-accent" />A tailored checklist
                      </li>
                      <li className="flex items-start gap-2">
                        <Check className="mt-0.5 h-4 w-4 text-accent" />A realistic timeline
                      </li>
                      <li className="flex items-start gap-2">
                        <Check className="mt-0.5 h-4 w-4 text-accent" />Clear next steps
                      </li>
                    </ul>
                  </div>
                </div>
